...
4. **System Hardening** — *is this machine configured safely?* Nine independent
   ...
   switched on, and what mode SELinux is in. Exposed as `hardening-audit` (`-H`).
...
| [System hardening audit](https://github.com/pasadoorian/fettle/wiki/System-hardening-audit) | `-H` and its nine axes, what each one can and can't see, and how to tune or disable them |
